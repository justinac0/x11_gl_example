...
#define LOG_FATAL(fmt, ...) { \
    log_printf(LOG_LEVEL_FATAL, \
        LOCATION_INFO\
        ANSI_COLOUR_RED  " [fatal] > "  ANSI_COLOUR_CLEAR \
        fmt, \
        "\n", \
        ##__VA_ARGS__); \
...
#define LOG_ERROR(fmt, ...) log_printf(\
    LOG_LEVEL_ERROR, \
    LOCATION_INFO\
    ANSI_COLOUR_RED " [error] " ANSI_COLOUR_CLEAR \
    fmt \
    "\n", \
    ##__VA_ARGS__\
)
...
#define LOG_INFO(fmt, ...) log_printf(\
    LOG_LEVEL_INFO, \
    LOCATION_INFO\
    ANSI_COLOUR_CYAN " [info] " ANSI_COLOUR_CLEAR \
    fmt \
    "\n", \
    ##__VA_ARGS__\
)
...
#define LOG_DEBUG(fmt, ...) log_printf(\
    LOG_LEVEL_DEBUG, \
    LOCATION_INFO\
    ANSI_COLOUR_MAGENTA " [debug] " ANSI_COLOUR_CLEAR \
    fmt \
    "\n", \
    ##__VA_ARGS__\
)
